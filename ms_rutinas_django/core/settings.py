...
DATABASES = {
    'default': {
        ...
        'NAME': env('DB_NAME', default='rutinas_db'),
        'USER': env('DB_USER', default='admin_pg'),
        'PASSWORD': env('DB_PASSWORD', default='password_pg'),
        'HOST': env('DB_HOST', default='db_rutinas_pg'),
...
# Para que no tengas dolores de cabeza con los puertos y dispositivos en la presentación:
